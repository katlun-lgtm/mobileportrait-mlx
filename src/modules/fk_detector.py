...
class FKDetector(nn.Module):
    ...
    def _init_insightface(self):
        ...
        self._app = FaceAnalysis(allowed_modules=["detection", "landmark_2d_106"])
    ...
    def forward(self, image: torch.Tensor) -> torch.Tensor:
        ...
        for i, im in enumerate(imgs):
            ...
            if faces:
                lmk = faces[0].landmark_2d_106  # (106,2) pixels
                out[i] = torch.from_numpy(lmk / np.array([W, H]) * 2 - 1).float()
        return out
